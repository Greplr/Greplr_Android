    ...
    public static ArrayList<Category> getTopCategories() {
        if (topCategories == null) {
            ...
            topCategories.add(new Category(
                    ...
                    ShoppingFragment.newInstance(Route.CAT_ORDER_SHOPPING)));
            ...
            topCategories.add(new Category(
                    ...
                    NewsFragment.newInstance(Route.CAT_ORDER_NEWS)));
        }
